// import 'dart:async';
//
// import 'package:neom_maps_services/domain/models/google_maps_places.dart';
...
//
//       expect(p1.text, 'Paris, France');
//       ///DEPRECATED expect(p1.distanceMeters, 8030004);
//       expect(p1.placeId, '691b237b0322f28988f3ce03e321ff72a12167fd');
//       ///DEPRECATED expect(p1.matchedSubstrings, hasLength(1));
//       ///DEPRECATED expect(p1.matchedSubstrings?.first, MatchedSubstring(offset: 0, length: 5));
//       expect(p1.placeId, 'ChIJD7fiBh9u5kcRYJSMaMOCCwQ');
//       ///DEPRECATED expect(p1.reference, 'CjQlAAAA_KB6EEceSTfkteSSF6U0pvumHCoLUboRcDlAH05N1pZJLmOQbYmboEi0SwXBSoI2EhAhj249tFDCVh4R-PXZkPK8GhTBmp_6_lWljaf1joVs1SH2ttB_tw');
//       ///DEPRECATED expect(p1.terms, [Term(offset: 0, value: 'Paris'), Term(offset: 7, value: 'France')]);
